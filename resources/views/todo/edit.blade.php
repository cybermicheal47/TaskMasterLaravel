            ...
            <form action="{{ route('tasks.update', $task->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description"  rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500">{{ old('description', $task->description) }}</textarea>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="date" id="due_date" name="due_date" required value="{{ old('due_date', $task->due_date) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                </div>
                ...
                <div class="mb-6">
                    ...
                    @if ($task->file_path)
                        <p class="mt-2 text-sm text-gray-500">
                            Current File:
                            <a href="{{ asset('storage/' . $task->file_path) }}" target="_blank" class="text-blue-600 underline">
